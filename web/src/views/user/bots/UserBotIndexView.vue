            ...
            <div class="col-9">
                <div class="card" style="margin-top: 25px;">
                    <div class="card-header">
                        <span style="font-size: 150%; font-weight: bold;">我的Bot</span>
                        <button type="button" class="btn btn-success" style="float: right;" data-bs-toggle="modal" data-bs-target="#add_bot_button">创建Bot</button>

                        <!-- Modal -->
                        <div class="modal fade" id="add_bot_button" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                            ...
                                            <input v-model="botadd.title" type="text" class="form-control" id="bot-add-title" placeholder="请输入Bot名称">
                                        </div>
                                        <div class="mb-3">
                                            <label for="add-bot-description" class="form-label">简介</label>
                                            <textarea v-model="botadd.description" class="form-control" id="bot-add-description" rows="3" placeholder="请输入Bot简介"></textarea>
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" @click="add_bot">确定</button>
...
export default {
    ...
    setup() {
        ...
        let bots = ref([]);
        const botadd = reactive({ // 绑定对象用reactive
            title: "",
            description: "",
            content: "",
            error_message: "",
        ...
        const add_bot = () => {
            ...
            $.ajax({
                ...
                type: "post",
                data: {
                    title: botadd.title, // reactive对象不用加.value，ref需要
        ...
        const update_bot = bot => {
            ...
            $.ajax({
                ...
                data: {
                    bot_id: bot.id,
                    title: bot.title, // reactive对象不用加.value，ref需要
